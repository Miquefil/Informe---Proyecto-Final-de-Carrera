...
Específicamente se utilizó la primer opción, donde la señal alimenta una cadena de retardos, la cuál se 
registra a cada clock. Cuando se detecta la entrada de un pulso, se genera una señal de \textit{Start}, y
...
con un asterisco en las figuras. En la Figura \ref{fig: histograma_500} se observa que gran parte de las mediciones
...
se representa en su forma complementaria al sumarle un período.
